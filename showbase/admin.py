...
from showbase.models import Podotchet, Vedomost, Check, Place, Persons
...
class PodotchetAdmin(admin.ModelAdmin):
    ...
    actions = [make_inv_action("Инвентаризировать"), export_as_csv_action("Экспортировать выделенное в CSV файл",
                                                                          fields=['name_el', 'inv_number', 'place',
                                                                                  'date_now']), ]
    list_per_page = 50
    fieldsets = [
        (None, {'fields': ['list_t']}),
